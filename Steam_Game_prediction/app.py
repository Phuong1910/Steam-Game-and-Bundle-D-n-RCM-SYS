...
class Input_FORM(FlaskForm):
    ...
    """
    name = StringField('Nhập số thứ tự của user: ',validators=[DataRequired()])
...
def name():
    ...
    return render_template('input.html',name = name, form = form,data_id = data, data_predict = rcmd, app_id=allgameid)
